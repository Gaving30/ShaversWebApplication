...
public class NVPAPICaller
{
    ...
    public string APIUsername = "gaving30-facilitator_api1.gmail.com";
    private string APIPassword = "L3RQ8YFR4PN78YE4";
    private string APISignature = "An5ns1Kso7MWUdW4ErQKJJJ4qi4-ACCxKJ-ozBUjBM4zwyZyh-EQ18at";
  ...
  public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
  {
    ...
    encoder["BRANDNAME"] = "Shavers Web Application";
    ...
    using (ShaversWebApplication.Logic.ShoppingCartActions myCartOrders = new ShaversWebApplication.Logic.ShoppingCartActions())
    {
